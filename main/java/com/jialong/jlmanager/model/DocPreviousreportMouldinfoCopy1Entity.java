 ...
 */
@Entity
@Table(name = "DOC_PREVIOUSREPORT_MOULDINFO_COPY_1")
public class DocPreviousreportMouldinfoCopy1Entity implements java.io.Serializable {
    /** 版本号 */
    private static final long serialVersionUID = 3159613009570509124L;
