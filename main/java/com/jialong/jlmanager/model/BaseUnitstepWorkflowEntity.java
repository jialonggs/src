 ...
 */
@Entity
@Table(name = "BASE_UNITSTEP_WORKFLOW")
public class BaseUnitstepWorkflowEntity implements java.io.Serializable {
    /** 版本号 */
    private static final long serialVersionUID = -3221153355419897772L;
