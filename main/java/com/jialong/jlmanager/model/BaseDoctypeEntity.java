 ...
 */
@Entity
@Table(name = "BASE_DOCTYPE")
public class BaseDoctypeEntity implements java.io.Serializable {
    /** 版本号 */
    private static final long serialVersionUID = -1947584362500437003L;
    ...
    /** 文档名称 */
    @Column(name = "DOCNAME", nullable = true, length = 255)
    private String docname;

    /** 文档编号 */
    @Column(name = "DOCCODE", nullable = true, length = 10)
